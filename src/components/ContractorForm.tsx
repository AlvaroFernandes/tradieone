...
import { createContractor, updateContractor } from "@/services/ContractorsService";
...
interface ContractorFormProps {
  ...
  initialValues?: Partial<ContractorFormValues>;
}
...
const ContractorForm: React.FC<ContractorFormProps> = ({
  ...
  React.useEffect(() => {
    if (type === "edit" && initialValues) {
      const iv = initialValues as Partial<ContractorFormValues> & {
        address1?: string;
        address2?: string;
        stateName?: string;
      };

      const mapped: Partial<ContractorFormValues> = {
        ...defaultValues,
        ...initialValues,
      ...
      reset(mapped as ContractorFormValues);
    }
      ...
      <form className="space-y-4" onSubmit={form.handleSubmit(onSubmit)}>
        ...
        <div className="flex justify-end gap-2 pt-2">
          ...
          <Button type="submit" className="bg-blue-600 hover:bg-blue-700">
            {type === "edit" ? "Update Contractor" : "Add Contractor"}
          </Button>
        </div>
      </form>
    </Form>
