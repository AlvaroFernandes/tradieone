      ...
      >
        ...
        <div className="space-y-5">
          ...
          <p className="font-inter text-base leading-7 text-white/70">
            Your business details are used to generate professional quotes, invoices, and legal
            compliance documents. Let's get the basics right.
          </p>
        </div>
